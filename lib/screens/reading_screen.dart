...
class _ReadingScreenState extends State<ReadingScreen> {
  ...
  void initState() {
    ...
    // Not awaiting in initState but it will run in background
    _updateProgress();
  }
      ...
      body: GestureDetector(
        ...
        child: PageView.builder(
          ...
          onPageChanged: (index) {
            ...
            _updateProgress(); // Call and don't await to keep UI smooth
  },
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      onTap: () async {
                        ...
                        // Await update before animating for consistency
                        await _bookService.updateReadingHistory(widget.book.id, chapter.id, 0);
  ...
  Future<void> _updateProgress() async {
    if (widget.book.chapters.isNotEmpty) {
      await _bookService.updateReadingHistory(
          widget.book.id, widget.book.chapters[_currentChapter].id, 0);
    }
  }
}
